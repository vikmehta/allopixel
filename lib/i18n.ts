...
const translations = {
  en: {
    ...
    pricing: {
      ...
      sub: "From a quick landing page to a full custom build — we build on whatever platform fits your business: Next.js, WordPress, Wix, Squarespace or Shopify. Fast, professional, and built to convert.",
      ...
      tiers: [
        ...
        { name: "Site Essential", price: "$899", period: "", tagline: "For small businesses going online for the first time", features: ["Custom design (desktop + mobile)", "Up to 5 pages", "Contact form & lead capture", "Basic SEO setup", "English & French available", "Next.js, WordPress, Wix, Squarespace or Shopify"] },
  ...
  fr: {
    ...
    pricing: {
      ...
      sub: "D'une page d'atterrissage à une création sur mesure complète — nous construisons sur la plateforme qui convient à votre entreprise : Next.js, WordPress, Wix, Squarespace ou Shopify. Rapide, professionnel et conçu pour convertir.",
      ...
      tiers: [
        ...
        { name: "Site Essential", price: "899 $", period: "", tagline: "Pour les petites entreprises qui se lancent en ligne", features: ["Conception sur mesure (bureau + mobile)", "Jusqu'à 5 pages", "Formulaire de contact et capture de prospects", "Configuration SEO de base", "Anglais et français disponibles", "Next.js, WordPress, Wix, Squarespace ou Shopify"] },
